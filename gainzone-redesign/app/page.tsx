  ...
  return (
    <div className="app-layout">
      <aside className="sidebar">
        <div style={{ marginBottom: '2.5rem', paddingLeft: '2px' }}>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: '18px', fontWeight: 500, letterSpacing: '2px', lineHeight: 1, color: 'var(--text)' }}>
            GAINZONE
          </div>
          <div style={{ fontSize: '10px', color: 'var(--muted)', marginTop: '5px', fontFamily: 'var(--font-display)', letterSpacing: '1px' }}>GYM COACH</div>
        </div>
        {TABS.map(t => (
  ...
  return (
    <div>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <div style={{ fontSize: '12px', color: 'var(--muted)', marginTop: '8px', fontFamily: 'var(--font-display)', letterSpacing: '0.3px' }}>timer · calculators</div>
      </div>
...
function DumbIcon({ size = 20 }: { size?: number }) {
...
function ToolIcon({ size = 20 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93A10 10 0 0 0 6.99 3.34L9 9l-5.5 3.18A10 10 0 1 0 19.07 4.93z"/></svg>
}
